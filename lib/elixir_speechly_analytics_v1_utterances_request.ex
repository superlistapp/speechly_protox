...
defmodule Speechly.Analytics.V1.UtterancesRequest do
  @moduledoc false
  defstruct app_id: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_app_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Analytics.V1.UtterancesRequest))
        end
      )
    )
