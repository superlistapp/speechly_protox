...
defmodule Speechly.Sal.V1.AppSource do
  @moduledoc false
  defstruct app_id: "",
            language: "",
            data_chunk: "",
        ...
        try do
          if msg.content_type == :CONTENT_TYPE_UNSPECIFIED do
            ...
            [
              ...
              " ",
              msg.content_type
              |> Speechly.Sal.V1.AppSource.ContentType.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Sal.V1.AppSource))
        end
      )
    )
      ...
      defp parse_key_value(bytes, msg) do
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {4, _, bytes} ->
              {value, rest} =
                Protox.Decode.parse_enum(bytes, Speechly.Sal.V1.AppSource.ContentType)
  ...
  (
      ...
      %{
        ...
        4 =>
          {:content_type, {:scalar, :CONTENT_TYPE_UNSPECIFIED},
           {:enum, Speechly.Sal.V1.AppSource.ContentType}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        content_type:
          {4, {:scalar, :CONTENT_TYPE_UNSPECIFIED},
           {:enum, Speechly.Sal.V1.AppSource.ContentType}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :content_type,
          tag: 4,
          type: {:enum, Speechly.Sal.V1.AppSource.ContentType}
        }
      ]
    end
