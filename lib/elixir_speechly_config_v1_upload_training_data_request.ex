...
defmodule Speechly.Config.V1.UploadTrainingDataRequest do
  @moduledoc false
  defstruct app_id: "", data_chunk: "", content_type: :CONTENT_TYPE_UNSPECIFIED, __uf__: []
      ...
      defp encode_data_chunk(acc, msg) do
        try do
          if msg.data_chunk == "" do
            ...
            [acc, "\x12", Protox.Encode.encode_bytes(msg.data_chunk)]
          end
        rescue
          ArgumentError ->
        ...
        try do
          if msg.content_type == :CONTENT_TYPE_UNSPECIFIED do
            ...
            [
              ...
              "\x18",
              msg.content_type
              |> Speechly.Config.V1.UploadTrainingDataRequest.ContentType.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Config.V1.UploadTrainingDataRequest))
        end
      )
    )
            ...
            {3, _, bytes} ->
              {value, rest} =
                Protox.Decode.parse_enum(
                  bytes,
                  Speechly.Config.V1.UploadTrainingDataRequest.ContentType
                )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:data_chunk, {:scalar, ""}, :bytes},
        3 =>
          {:content_type, {:scalar, :CONTENT_TYPE_UNSPECIFIED},
           {:enum, Speechly.Config.V1.UploadTrainingDataRequest.ContentType}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        content_type:
          {3, {:scalar, :CONTENT_TYPE_UNSPECIFIED},
           {:enum, Speechly.Config.V1.UploadTrainingDataRequest.ContentType}},
        data_chunk: {2, {:scalar, ""}, :bytes}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :content_type,
          tag: 3,
          type: {:enum, Speechly.Config.V1.UploadTrainingDataRequest.ContentType}
        }
      ]
    end
