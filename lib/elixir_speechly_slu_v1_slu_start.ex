...
defmodule Speechly.Slu.V1.SLUStart do
  @moduledoc false
  defstruct app_id: "", options: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_app_id(msg) |> encode_options(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Slu.V1.SLUStart))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[options: msg.options ++ [Speechly.Slu.V1.SLUStart.Option.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:options, :unpacked, {:message, Speechly.Slu.V1.SLUStart.Option}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        options: {2, :unpacked, {:message, Speechly.Slu.V1.SLUStart.Option}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :options,
          tag: 2,
          type: {:message, Speechly.Slu.V1.SLUStart.Option}
        }
      ]
    end
