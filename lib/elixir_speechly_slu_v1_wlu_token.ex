...
defmodule Speechly.Slu.V1.WLUToken do
  @moduledoc false
  defstruct word: "", index: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_word(msg) |> encode_index(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Slu.V1.WLUToken))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{1 => {:word, {:scalar, ""}, :string}, 2 => {:index, {:scalar, 0}, :int32}}
    end
    ...
    def defs_by_name() do
      %{index: {2, {:scalar, 0}, :int32}, word: {1, {:scalar, ""}, :string}}
    end
  )
