...
defmodule Speechly.Sal.V1.ExtractSALSourcesResult do
  @moduledoc false
  defstruct data_chunk: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_data_chunk(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Speechly.Sal.V1.ExtractSALSourcesResult))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Speechly.Sal.V1.ExtractSALSourcesResult,
