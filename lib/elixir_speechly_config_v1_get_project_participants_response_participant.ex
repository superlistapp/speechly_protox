...
defmodule Speechly.Config.V1.GetProjectParticipantsResponse.Participant do
  @moduledoc false
  defstruct name: "", email: "", id: "", __uf__: []
      ...
      defp encode_email(acc, msg) do
        try do
          if msg.email == "" do
            ...
            [acc, "\x12", Protox.Encode.encode_string(msg.email)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_id(acc, msg) do
        try do
          if msg.id == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.id)]
          end
        rescue
          ArgumentError ->
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Speechly.Config.V1.GetProjectParticipantsResponse.Participant)
          )
        end
      )
    )
